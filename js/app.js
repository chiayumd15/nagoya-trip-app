...
旅行：2026/10/10–10/19，共 11 人兩家族。楊家 5 人（楊才廣、黃思婷、楊家喻、張志郁、楊書竣）10/10 JX822 TPE10:15→KIX14:00，先玩大阪京都，10/13 新幹線到名古屋。陳家 6 人（陳永康、楊淑媛、陳玟玲、高魁澤、陳玟潔、陳玟綺）10/13 星宇 TPE15:55→NGO18:45。全員 10/19 JX839 NGO19:55→TPE22:00。
...
function renderMore() {
  ...
  <div class="card"><h2>👨‍👩‍👧‍👦 11 人名單・房號・航班</h2><div class="tablewrap"><table><thead><tr><th>姓名</th><th>房</th><th>早餐</th><th>去程</th></tr></thead><tbody>${people}</tbody></table></div><div class="tiny muted">分組是依姓氏推的：楊家 5 人、陳家 6 人。若有誤請告訴家喻改 data.js。</div><div class="btnrow"><button class="btn sm" data-act="me">切換我是誰</button></div></div>
